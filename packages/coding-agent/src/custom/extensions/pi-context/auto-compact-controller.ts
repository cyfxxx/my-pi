...
import { recordTaskRecord } from "../../services/task-record.ts";
import { extractUserRequest } from "./message-utils.ts";
import { inferTaskType } from "./thinking-level.ts";
import { markCompacted } from "../../services/context-budget.ts";
import { snapshotBeforeCompact } from "./compression.ts";
import { makeAutoContinueGate, makeCompactDecider } from "../../services/auto-compact.ts";
