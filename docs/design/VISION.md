...
| 更新日期 | 2026-09-12 |
| 适用范围 | 项目愿景、方法论、治理规则 |
| 相关文档 | [SELF-OPTIMIZING-ROADMAP.md](./SELF-OPTIMIZING-ROADMAP.md), [OPTIMIZATION-LOG.md](../maintenance/OPTIMIZATION-LOG.md) |
...
- [三、方法论：软硬结合](#三方法论软硬结合)
- [四、度量体系](#四度量体系)
- [五、记忆生命周期治理规则](#五记忆生命周期治理规则-v1)
- [六、未来展望](#六未来展望受限于算力与技术暂缓)
- [七、与现有文档的关系](#七与现有文档的关系)
- [八、变更记录](#八变更记录)
...
| 任务 | 成功率代理 / 干预次数 / token 成本（按会话聚合） | .pi/extensions/pi-autopilot/scripts/task-metrics.mjs（usage-diag + interventions） | ✅ P2 |
| 回归 | golden tasks（行为防退化基准） | scripts/maintenance/golden-tasks.sh（--fast 确定性 / --full 无头会话） | ✅ P3 |
| 记忆库 | 规模 / 陈旧度 / 升格候选 / 冲突嫌疑 | .pi/extensions/pi-memory/scripts/memory-lifecycle.mjs（只读报告） | ✅ P4 |
