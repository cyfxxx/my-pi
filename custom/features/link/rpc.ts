...
import type { DeviceAddr, DeviceConfig, OutboxEntry } from './logic';
import {
  deviceAddresses,
  parseState,
  selfName,
...
import { buildRemoteCommand, remoteExec, homeCat, probeAddr } from './transport';
import type { SendOptions, RpcEvent } from './transport';
