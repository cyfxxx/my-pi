...
// Local stubs (decoupled from token-budget)
function getTokenPressureTag(): string { return ''; }
function getUrgencyHint(): string { return ''; }
function getBudgetReport(): { pressure: string } { return { pressure: 'normal' }; }
